...
public class JobConf extends Configuration {
	...
	public void next() {
		...
		setOutputKeyComparatorClass(currentConf.getClass(
				"mapred.output.key.comparator.class", Text.Comparator.class,
				RawComparator.class));
		setReduceOutputKeyComparatorClass(currentConf.getClass(
				"mapred.reduceoutput.key.comparator.class", Text.Comparator.class,
				RawComparator.class));		
		setOutputValueGroupingComparator(currentConf.getClass(
				"mapred.output.value.groupfn.class", Text.Comparator.class,
				RawComparator.class));
    ...
    // *************leon**********************************
	public RawComparator getReduceOutputKeyComparator() {
		Class<? extends RawComparator> theClass = getClass(
				"mapred.reduceoutput.key.comparator.class", null, RawComparator.class);
		if (theClass != null)
			return ReflectionUtils.newInstance(theClass, this);
		return WritableComparator.get(getOutputKeyClass().asSubclass(
				WritableComparable.class));
	}
	
	
	public void setReduceOutputKeyComparatorClass(
			Class<? extends RawComparator> theClass) {
		setClass("mapred.reduceoutput.key.comparator.class", theClass,
				RawComparator.class);
	}
//****************************************************************************************
	/**
